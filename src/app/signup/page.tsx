      ...
      <main className="flex w-full max-w-sm flex-col gap-6 px-6 py-16">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <button
            ...
            className="mt-2 flex h-12 w-full items-center justify-center rounded-full bg-foreground px-5 text-base font-medium text-background transition-colors hover:bg-[#383838] disabled:opacity-50 dark:hover:bg-[#ccc]"
          >
